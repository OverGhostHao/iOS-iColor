...
-(void) setUpMenu {
    ...
    self.drawImage = [[UIImageView alloc]initWithFrame:CGRectMake(viewX, viewY, viewWidth, viewHeight - palateHeight - (NSInteger)functionBoardHeight)];
    self.mainImage = [[UIImageView alloc]initWithFrame:CGRectMake(viewX, viewY, viewWidth, viewHeight - palateHeight - (NSInteger)functionBoardHeight)];
